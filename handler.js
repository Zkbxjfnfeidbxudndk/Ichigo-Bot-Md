...
if(m.id.startsWith('NJX-') || m.id.startsWith('Lyru-') || m.id.startsWith('EvoGlobalBot-') || m.id.startsWith('BAE5') && m.id.length === 16 || m.id.startsWith('3EB0') && m.id.length === 12 || m.id.startsWith('3EB0') && (m.id.length === 20 || m.id.length === 22) || m.id.startsWith('B24E') || m.id.startsWith('8SCO') && m.id.length === 20 || m.id.startsWith('FizzxyTheGreat-') || m.id.startsWith('ArabDevs')) return
...
if (!m.fromMem && m.text.match(/(@212766846979‬|الاستور|كايتو|بوت|:v)/gi)) {
...
if (media === 'texto') {
this.sendMessage(id, { text: text, contextInfo: { forwardedNewsletterMessageInfo: { newsletterJid: '120363399336067154@newsletter', serverMessageId: '', newsletterName: '𝐈𝐂𝐇𝐈𝐆𝐎-𝐁𝐎𝐓🦋' }, forwardingScore: 9999999, isForwarded: true, mentionedJid: [user], externalAdReply: { showAdAttribution: true, renderLargerThumbnail: true, thumbnail: apii.data, title: [wm, ' ' + wm + '😊', '🌟'].getRandom(), containsAutoReply: true, mediaType: 1, sourceUrl: [nna, nna2, nnntt, yt].getRandom() } } }, { quoted: fkontak2 });
}
if (media === 'audio') {
this.sendMessage(id, { audio: { url: vn }, contextInfo: { forwardedNewsletterMessageInfo: { newsletterJid: '120363399336067154@newsletter', serverMessageId: '', newsletterName: '𝐈𝐂𝐇𝐈𝐆𝐎-𝐁𝐎𝐓🦋' }, forwardingScore: 9999999, isForwarded: true, mentionedJid: [user], externalAdReply: { mediaType: 1, previewType: "PHOTO", thumbnail: apii.data, title: `乂◈🌗╎ مـرحـبـا يـا برو 乂`, body: [wm, ' ' + wm + '😊', '🌟'].getRandom(), showAdAttribution: true, renderLargerThumbnail: true, sourceUrl: [nna, nna2, nnntt, yt].getRandom() } }, ptt: true, mimetype: 'audio/mpeg', fileName: `error.mp3` }, { quoted: fkontak2 });
}}}}
...
let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝐈𝐂𝐇𝐈𝐆𝐎-𝐁𝐎𝐓 🌗;;;\nFN:𝐈𝐂𝐇𝐈𝐆𝐎-𝐁𝐎𝐓\nORG:𝐈𝐂𝐇𝐈𝐆𝐎-𝐁𝐎𝐓 🌸\nTITLE:\nitem1.TEL;waid=33760509044:+337 60 50 90 44\nitem1.X-ABLabel:𝐈𝐂𝐇𝐈𝐆𝐎-𝐁𝐎𝐓 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴇsᴄʀɪʙɪ sᴏʟᴏ ᴘᴏʀ ᴄᴏsᴀs ᴅᴇʟ ʙᴏᴛ.\nX-WA-BIZ-NAME:𝐊𝐈𝐓𝐎-𝐁𝐎𝐓 👑\nEND:VCARD`
await this.sendMessage(nk.from, { contacts: { displayName: '𝐈𝐂𝐇𝐈𝐆𝐎-𝐁𝐎𝐓 🪽', contacts: [{ vcard }] }}, {quoted: callmsg})
...
let msg = {
  rowner: await tr('*❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n + ◞🪶◜⇓ هذا الأمـر مخصص لـلمـطـور الـرئـيـسـي فقط ✧\n + *❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n'),
  owner: await tr('*❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n + ◞🪶◜⇓ هـذا الأمـر مخصص لـلمـالـك فقط ✧\n + *❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n'),
  mods: await tr('*❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n + ◞🪶◜⇓ هـذا الأمـر مخصص لـلمـشـرفـيـن فقط ✧\n + *❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n'),
  premium: await tr('*❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n + ◞🪶◜⇓ هـذا الأمـر مخصص لأعضاء ❪VIP❫ فقط ✧\n + *❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n'),
  group: await tr('*❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n + ◞🪶◜⇓ هـذا الأمـر يعمل في المجـمـو؏ـات فقط ✧\n + *❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n'),
  private: await tr('*❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n + ◞🪶◜⇓ هـذا الأمـر يعمل في الخاص فقط ✧\n + *❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n'),
  admin: await tr('*❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n + ◞🪶◜⇓ هـذا الأمـر مخصص لمشرفي المجموعـة ✧\n + *❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n'),
  botAdmin: await tr('*❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n + ◞🪶◜⇓ يجب أن يكون البوت أدمن لتفعيل هذا الأمر ✧\n + *❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n'),
  unreg: await tr('╭ׁ۪\n + ┊ׁ⇇ يجب أن تكون مسجل لاستخدام هذا الأمر\n + ┊•⪼ استخدم الأمر: .تسجيل اسمك.عمرك\n + ┊•⪼ مثال: .تسجيل mix.16\n + *❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n'),
  restrict: await tr('*❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n + ◞🪶◜⇓ هـذا الأمـر مغلق من طرف المطور ✧\n + *❃━━━═✦•〘•🌗•〙•✦═━━━❃*\n')
}[type];
if (msg) return conn.sendMessage(m.chat, {text: msg, contextInfo: { mentionedJid: null, forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363399336067154@newsletter', serverMessageId: '', newsletterName: '𝐈𝐂𝐇𝐈𝐆𝐎-𝐁𝐎𝐓' }, externalAdReply : {mediaUrl: null, mediaType: 1, description: null, "title": `𝐈𝐂𝐇𝐈𝐆𝐎-𝐁𝐎𝐓`, body: wm, previewType: 0, "thumbnail": img.getRandom(), sourceUrl: [nna, nna2, md, yt, nn, tiktok].getRandom()}}}, { quoted: m })
}
