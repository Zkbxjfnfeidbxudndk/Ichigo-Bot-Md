...
let canalNombre = ["*𝐈𝐂𝐇𝐈𝐆𝐎*-MD 🌒🕷", "اضغط هنا", "ICHIGO bot 🌒", "*ICHIGO*✨️🌗"]
...
export function serialize() {
  ...
  return Object.defineProperties(proto.WebMessageInfo.prototype, {
    ...
    isBaileys: {
      get() {
      return (this?.fromMe || areJidsSameUser(this.conn?.user.id, this.sender)) && this.id.startsWith('ArabDevs') || false
	},
    }, 
    chat: {
      get() {
